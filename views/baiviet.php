<?php
  $lienquan=$data->lienquan($page['data']['id'],$page['data']['danh_muc']);
               ...
               <div class="title">
                  ...
                  <nav class="bread-crumbs">
                     <ul>
                        ...
                        <li><a href="blog" style="color:#0dc0c0 !important;">Tin tức</a></li>
                        <li style="color:#0dc0c0 !important;">/</li>
                        <li><span class="current"><a href="blog/<?=$page['data']['url']?>" style="color:#0dc0c0 !important;"><?=$page['data']['name']?></a></span></li>
                     </ul>
                  </nav>
               </div>
            </div>
               ...
               <div class="row">
                  <article class="column span-8">
                     ...
                     <footer class="meta-info">
                        <p><span class="meta-item meta-date"><i class="l-clock-o"></i> <?php echo date('d/m/Y',strtotime($page['data']['ngay_dang'])); ?></span> <span class="meta-item meta-category"><i class="l-folder-open-o"></i>  <a href="blog" title=" Tin tức">Tin tức</a></span> <span class="meta-item meta-author"><i class="l-user"></i> <a href="blog/<?=$page['data']['url']?>" tiêu đề=" admin" rel="tác giả">admin</a></span></p>
                     </footer>
                     <div class="story">
                        <?=$page['data']['noi_dung']?>
                     </div>
                     ...
                     <div class="widget relative-post-default">
                        <h5 class="section-nav-title">Tin tức Liên quan</h5>
                        <ul>
                          <?php foreach ($lienquan as $lq) { ?>
                           <li><a href="blog/<?=$lq['url']?>" title="<?=$lq['name']?>"><?=$lq['name']?></a></li>
                          <?php } ?>
                        </ul>
                     </div>
                  </article>
