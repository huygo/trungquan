...
<section class="v2_bnc_inside_page">
   ...
   <section id="products-main" class="v2_bnc_products_page">
      ...
      <div class="row margin-top-20">
         <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
            <div class="v2_bnc_title_page">
               <h2 class="no-top-space">Tìm kiếm :<?=$keyword?></h2>
            </div>
         </div>
         <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
            ...
            <figure class="v2_bnc_pr_item_img">
               ...
               <div class="v2_bnc_pr_item_action">
                  ...
                  <div class="v2_bnc_pr_item_buy">
                     <a href="javascript:void(0)" title="Đặt Mua" class="BNC-add-cart v2_bnc_pr_item_action_buy" data-price-float="220000.00.00" data-name="Áo choàng tắm người lớn dùng trong khách sạn" data-type="tab-home"  data-price="Array" data-product="988019" data-quantity="1" data-total-quantity="100"><i class="icon-basket icons"></i></a> 
                  </div>
                  <!-- End Buy -->
                  ...
                  <div class="v2_bnc_pr_item_compare">
                     <a class="v2-products-btn-compare compare BNC-compare" title="So Sánh sản phẩm" data-product="988019" data-category="291666,395910" data-name="Áo choàng tắm người lớn dùng trong khách sạn"><i class="icon-shuffle icons"></i></a>
                  </div>
                  <!-- End Compare -->
               </div>
               <!-- End Action Btn --> 
      ...
      <?php if ($trang>1 && $sotrang>1) {
         echo '<li><a href="search?key='.$keyword.'/&p='.($trang-1).'"> ← </a></li>';
      }else{
